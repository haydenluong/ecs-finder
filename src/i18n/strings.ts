...
export const vi = {
    ...
    'submit.successBody': 'Hoạt động của bạn đang chờ duyệt. Sau khi được duyệt, hoạt động sẽ xuất hiện trên trang chủ.',
...
export const en: Partial<Record<StringKey | PluralKey, string>> = {
    ...
    'submit.successBody': 'Your activity is awaiting review. Once approved, it will appear on the home page.',
